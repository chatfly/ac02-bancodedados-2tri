...
values(1,'Paris','Torre Eiffel e Museu do Louvre',150,4.8)

insert into destinos
(id,destino,atracoes,custoDiario,avaliacao)
values(2,'Paris','Torre Eiffel e Alguma coisa',120,4.2)
...
insert into clientes
(id,nome,email)
values(2,'nicolas','nicolasnicolas@nicolas.nicolas')
...
insert into avaliacoes
(id,destino,estrela,comentario)
values(2,'Tóquio',4.5,'Lugar muito legal cheio de asiáticos')

insert into avaliacoes
(id,destino,estrela,comentario)
values(3,'Tóquio',3,'Nunca mais volto, não tem guaraná lá')

update clientes set email='novo.email@example.com'
where email='joao.silva@example.com'

update destinos set atracoes = 'Arco Do Triunfo'
where destino='Paris'
...
update destinos set atracoes='Museu do Louvre e Arco do Triunfo'
where destino='Paris'
